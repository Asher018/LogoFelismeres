...
image_folder = 'logos/all'
output_folder = 'logos/output'

bbox_file = 'logos/all/all.txt'
...
for line in lines:
    ...
    if image[j] is not None:
        for i in range(1, len(parts), 6):
            ...
            center_pont_x = (x1-x0) // 2
            center_pont_y = (y1-y0) // 2
            center_x2 = x0 + center_pont_x
            center_y2 = y0 + center_pont_y
            rec_x0 = math.floor(center_x2 - 50)
            rec_x1 = math.floor(center_x2 + 50)
            rec_y0 = math.floor(center_y2 - 50)
            rec_y1 = math.floor(center_y2 + 50)
