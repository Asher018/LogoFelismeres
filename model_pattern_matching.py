...
logo_image_path = 'logos/test_pattern_matching/audi_1.jpg'
...
if image is not None:
    ...
    cv2.imwrite("logos/test_pattern_matching/image.jpg", image)
    cv2.imwrite("logos/test_pattern_matching/image2.jpg", img_box2)
else:
